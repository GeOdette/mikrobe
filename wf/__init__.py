...
def mykrobe_task(species: str,
    ...
    return LatchFile(str(mykrobe_output), f"{output_dir.remote_path}/{mykrobe_output}")
...
def mikrobe(species: str,
    ...
    This is a latch implementation of the Mykrobe AMR predictor
